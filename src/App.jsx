...
const translations = {
  ...
  EN: {
    ...
    notFound: { denied: 'ACCESS_DENIED', error: 'ERROR: Under Development', emergency: 'Emergency Link', sub: 'Page under development. Scan to contact.', back: 'Вернуться в ядро' },
    beta: { 
      title: 'Join the Core', 
...
function FooterBlock({ onNavigateError, standardPadding, t }) {
  return (
    <footer className="bg-black text-white pt-16 pb-10 text-left relative z-10 border-t-2 border-black text-white">
      ...
      <div className="pt-[72px] w-full">
        ...
        <section className="bg-white border-b border-black py-16 text-left w-full overflow-hidden scroll-mt-[72px]">
          <div className={`w-full ${standardPadding} text-left`}>
            ...
            <p className="text-base sm:text-xl md:text-3xl font-bold tracking-tight text-black max-w-full text-left leading-snug">
              {String(t.gateway.desc)}
              <span className="bg-[#CCFF00] px-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] inline-block mx-1 text-black font-black uppercase">{String(t.gateway.highlight)}</span> 
              <span className="inline text-black text-left">{String(t.gateway.sub)}</span>
            </p>
          </div>
        </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mt-8 md:mt-12 text-black text-left">
          <div className="lg:col-span-5 space-y-8 md:space-y-12 text-left text-black">
            <div className="space-y-6 text-black text-left">
              ...
              <h1 className="text-[clamp(2.5rem,15vw,6rem)] md:text-8xl font-black uppercase tracking-tighter leading-[1.1] md:leading-[0.95] text-black text-left text-black">JOIN THE <br /> <span className="bg-[#CCFF00] px-2 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] border-2 border-black text-black">CORE.</span></h1>
          ...
          <div className="lg:col-span-7 text-black text-left">
            {status === 'idle' ? (
              ...
              <div className="bg-[#CCFF00] border-4 border-black p-8 md:p-20 text-center shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] animate-in zoom-in-95 duration-500 min-h-[400px] flex flex-col justify-center text-black text-center">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4 text-black text-center">{t.beta.success}</h2>
