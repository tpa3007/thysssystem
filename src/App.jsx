        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mt-8 md:mt-12 text-black text-left">
          <div className="lg:col-span-5 space-y-8 md:space-y-12 text-left text-black">
            <div className="space-y-6 text-black text-left">
              ...
              <h1 className="text-[clamp(2.5rem,15vw,6rem)] md:text-8xl font-black uppercase tracking-tighter leading-[1.1] md:leading-[0.9] text-black text-left text-black">JOIN THE <br /> <span className="bg-[#CCFF00] px-2 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] border-2 border-black text-black">CORE.</span></h1>
