...
// --- КОМПОНЕНТ: NavigationBlock (ФИКСИРОВАННАЯ ШАПКА - z-index повышен до 100) ---
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="pt-8 border-t border-black/10 text-black">
               <div className="flex items-center gap-4 text-black">
                  ...
                  <div className="text-left"><div className="text-[10px] font-black uppercase">{t.beta.helpTitle}</div><a href="https://t.me/thysssystem" target="_blank" rel="noopener noreferrer" className="text-[10px] font-bold opacity-40 uppercase hover:opacity-100 hover:text-blue-600 transition-all text-black">{t.beta.helpSub}</a></div>
               </div>
            </div>
          </div>
...
function LandingContent({ onNavigateError, onConnect, t, lang, setLang, standardPadding }) {
  ...
  return (
    <div className="text-black font-sans bg-white overflow-x-hidden">
      ...
      {/* Убираем зазор: отступ pt-[72px] ровно равен высоте шапки */}
